...
import { PencilIcon, MicrophoneIcon, ClipboardDocumentCheckIcon, FaceSmileIcon, Bars3Icon, XMarkIcon } from '@heroicons/react/24/outline'
    ...
    return (
        <header className="fixed z-50 top-0 left-0 right-0 border-b border-b-slate-500 backdrop-blur-lg">
            ...
            <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                ...
                <Dialog.Panel className="fixed inset-y-0 right-0 z-[51] w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
